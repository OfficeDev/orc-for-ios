...
@implementation MSSampleContainerItemAFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSSampleContainerItemA class]]) {

		_operations = [[MSSampleContainerItemAOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSSampleContainerItemA *itemA, MSOrcError *e))callback {
