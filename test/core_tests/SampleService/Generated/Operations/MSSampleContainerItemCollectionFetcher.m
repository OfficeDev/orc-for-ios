...
/**
* The implementation file for type MSSampleContainerItemCollectionFetcher.
*/

@implementation MSSampleContainerItemCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSSampleContainerItem class]];
}
...
- (MSSampleContainerItemFetcher *)getById:(NSString *)id {
    ...
    return [[MSSampleContainerItemFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
